...
═══════════════════════════════════════════════════════════════
📌 VERSIÓN: 8.0.0
📌 CAMBIOS v18: Migración Gemini API
📌 ESTRATEGIAS:
   ...
   - Gemini API:                Network-Only (nunca cachear respuestas de IA)
...
self.addEventListener('fetch', event => {
  ...
  // 1. API de Gemini — NUNCA cachear (respuestas de IA deben ser siempre frescas)
