...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const DRUG_KEYWORDS = ['pastilla', 'medicamento', 'medicamentos', 'droga', 'jarabe', 'tratamiento', 'para que sirve', 'dosis', 'medicina', 'inyeccion', 'suero', 'receta', 'farmacia', 'remedio', 'algo para', 'recomiendas'];
